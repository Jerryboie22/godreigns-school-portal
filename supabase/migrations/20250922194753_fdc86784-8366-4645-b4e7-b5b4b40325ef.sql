...
INSERT INTO public.assignments (teacher_id, title, description, subject, class_level, due_date) VALUES
((SELECT user_id FROM public.profiles WHERE role = 'teacher' LIMIT 1), 'Mathematics Assignment 1', 'Complete exercises 1-20 from Chapter 3', 'Mathematics', 'JSS 1', '2025-01-15'),
((SELECT user_id FROM public.profiles WHERE role = 'teacher' LIMIT 1), 'English Essay', 'Write a 500-word essay on "My Future Career"', 'English', 'SSS 2', '2025-01-18');